"""
Django settings for quiet_snow_40112 project.
...
ROOT_URLCONF = 'quiet_snow_40112.urls'
...
WSGI_APPLICATION = 'quiet_snow_40112.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_snow_40112 API",
    "DESCRIPTION": "API documentation for quiet_snow_40112 App",
    "VERSION": "v1",
}
